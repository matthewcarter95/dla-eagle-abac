...
const findIssuer =
  'https://developer.okta.com/docs/guides/terraform-create-custom-auth-server/main/#help-an-external-oauth-app-validate-the-token-issuer';
...
export default class JwtVerifier {
  ...
  async verifyToken(tokenString, options) {
    ...
    const reqOptions = {
      url: this.url,
      // url: 'https://demo-silver-cattle-71709.okta.com/oauth2/default/v1/keys',
      method: 'POST',
      headers: {
    ...
    // console.log('In verifyJWT...JWT is ' + jwt);
    // try {
    //   // do the verification
